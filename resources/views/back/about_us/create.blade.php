                ...
                <form method="POST" action="{{ route('about-us.store') }}">
                    ...
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Leave a comment here"
                            id="floatingTextarea" style="height: 150px;" name="part1"></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp" name="list1" required>

                    </div>
                    <div class="mb-3 mt-2">
                        <label for="exampleInputEmail1" class="form-label">About Us List 2</label>
                        <input type="text" class="form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp" name="list2">

                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">About Us List 3</label>
                        <input type="text" class="form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp" name="list3">

                    </div>
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Leave a comment here"
                            id="floatingTextarea" style="height: 150px;" name="Part2"></textarea>
                        <label for="floatingTextarea">About Us Part 1</label>
                    </div>
